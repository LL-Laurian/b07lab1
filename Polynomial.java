...
*/
    ...
    public Polynomial add (Polynomial src_polynomial) {
        ...
        if ((src_length == 1 && (src_polynomial.coefficient[0] == 0))){
            return this;
        }
        else if ((object_length == 1) && (coefficient[0] == 0)){
    ...
    public Polynomial multiply (Polynomial src_polynomial){
        int object_length = coefficient.length;
        int src_length = src_polynomial.coefficient.length;
        int max_length = object_length * src_length;
        ...
        Polynomial result = new Polynomial(new double[max_length], new int[max_length]);
        ...
        for (int i = 0; i < object_length; i++){
            for (int d = 0; d < src_length; d++) {
                ...
                result = result.add(new Polynomial(temp_coe, temp_exp));
            }
        }
        return result;
    }
